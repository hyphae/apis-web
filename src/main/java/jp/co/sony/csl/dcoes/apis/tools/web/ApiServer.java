 ...
 * - {@link ErrorGeneration} : Provides Web API for delivering errors from the
 * outside.
 * - {@link DealGeneration} : Provides Web API for delivering Power Sharing
 * information from the outside.
 * - {@link LogConfiguration} : Provides Web API for changing the log level from
 * the outside.
 * 
 * @author OES Project
